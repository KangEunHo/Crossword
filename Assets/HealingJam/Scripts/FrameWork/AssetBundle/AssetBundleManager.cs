...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
        ...
        public static bool UseCashWhenOffline { get; set; } = true;
		...
		static protected void LoadAssetBundle(string assetBundleName, bool isLoadingAssetBundleManifest = false)
		{
			...
			if (!isLoadingAssetBundleManifest)
			{
				...
				{
					Debug.LogWarning("Please initialize AssetBundleManifest by calling AssetBundleManager.Initialize()");
					//return;
				}
			}
		...
		static protected bool LoadAssetBundleInternal (string assetBundleName, bool isLoadingAssetBundleManifest)
		{
            ...
            {   
                ...
                else if (UseCashWhenOffline)
                {
                    ...
                    {
                        Hash128 recentHash = listOfCachedVersions[0];
                        download = UnityWebRequestAssetBundle.GetAssetBundle(url, recentHash, 0);
            ...
            // s_DownloadingWebrequests 루프를 돌면서 download가 null 이라면 error 목록으로 이동합니다.
        ...
        static public AssetBundleLoadAssetAllOperationFull LoadAllAssetAsync(string assetBundleName)
        {
            Log(LogType.Info, "Loading " + assetBundleName + " bundle");

            AssetBundleLoadAssetAllOperationFull operation = null;
//#if UNITY_EDITOR
//            if (SimulateAssetBundleInEditor)
//            {
...
//#endif
            {
                ...
                operation = new AssetBundleLoadAssetAllOperationFull(assetBundleName);
